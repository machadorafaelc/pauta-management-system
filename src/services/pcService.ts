...
const mapPCFromDB = (data: any): PedidoCompra => ({
  ...
  RESPONSAVEL_PRODUCAO: data.responsavel_producao,
  ...
  DATA_FATURAMENTO_NF_AGENCIA: data.data_faturamento_nf_agencia,
...
const mapPCToDB = (pc: PedidoCompra) => ({
  ...
  responsavel_producao: pc.RESPONSAVEL_PRODUCAO,
  responsavel_checking: pc.RESPONSAVEL_CHECKING,
  status_geral: pc.STATUS_GERAL,
  ...
  data_faturamento_nf_agencia: pc.DATA_FATURAMENTO_NF_AGENCIA,
